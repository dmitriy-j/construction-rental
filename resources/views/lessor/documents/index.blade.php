...
<div class="container py-5">
    ...
    <div class="alert alert-info mb-4">
        ...
        @elseif($type === 'contracts')
            Отображаются договоры с платформой
        ...
        <div class="card-body p-0">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        @elseif($type === 'contracts')
                            ...
                            <th class="py-3">Платформа</th>
                            <th class="py-3">Дата начала</th>
                            <th class="py-3">Дата окончания</th>
                            <th class="py-3">Статус</th>
                            <th class="py-3 text-end">Действия</th>
                        @elseif($type === 'completion_acts')
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('lessor.contracts.show', $doc) }}"
                                       class="btn btn-info" title="Просмотр" data-bs-toggle="tooltip">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @if($doc->file_path)
                                    <a href="{{ route('lessor.contracts.download', $doc) }}"
                    ...
                    <tr>
                        <td colspan="
                            @if($type === 'delivery_notes') 6
                            @elseif($type === 'waybills') 7
                            @elseif($type === 'contracts') 7
                            @elseif($type === 'completion_acts') 5
                            @endif
