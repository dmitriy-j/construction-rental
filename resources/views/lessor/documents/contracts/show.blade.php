        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{ route('lessor.contracts.index') }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left me-1"></i> Назад к списку
                    </a>
                </div>
                <h4 class="page-title">Договор №{{ $contract->number }}</h4>
            </div>
        </div>
    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('lessor.contracts.download', $contract) }}"
