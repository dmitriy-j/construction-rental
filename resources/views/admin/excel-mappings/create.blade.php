...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1>Создание шаблона УПД</h1>
        </div>
    </div>

    <form action="{{ route('admin.excel-mappings.store') }}" method="POST" enctype="multipart/form-data" id="templateForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control-file" id="file_example" name="file_example" accept=".xlsx,.xls" required>
        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="mapping_{{ $field }}_cell"
                                        ...
                                        value="{{ old('mapping.header.' . $field . '.cell', $config['cell'] ?? '') }}"
                                        required placeholder="Например: A1">
                                    <small class="form-text text-muted">Формат: буква колонки + номер строки (напр. A1)</small>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" id="mapping_{{ $field }}_parser"
                                        ...
                                        @foreach($parsers as $parserValue => $parserName)
                                            <option value="{{ $parserValue }}" {{ old('mapping.header.' . $field . '.parser') == $parserValue ? 'selected' : '' }}>
                                                {{ $parserName }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="mapping_{{ $field }}_description"
                                           ...
                                           value="{{ old('mapping.header.' . $field . '.description', $config['description'] ?? '') }}"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{ old('mapping.header.' . $field . '.' . $subField . '.cell', $subConfig['cell'] ?? '') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control"
                                            ...
                                            @foreach($parsers as $parserValue => $parserName)
                                                <option value="{{ $parserValue }}" {{ old('mapping.header.' . $field . '.' . $subField . '.parser') == $parserValue ? 'selected' : '' }}>
                                                    {{ $parserName }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{ old('mapping.header.' . $field . '.' . $subField . '.description', $subConfig['description'] ?? '') }}"
                                               placeholder="Описание поля">
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="mapping_amounts_{{ $field }}_cell"
                                       ...
                                       value="{{ old('mapping.amounts.' . $field . '.cell', $config['cell'] ?? '') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" id="mapping_amounts_{{ $field }}_parser"
                                    ...
                                    @foreach($parsers as $parserValue => $parserName)
                                        <option value="{{ $parserValue }}" {{ old('mapping.amounts.' . $field . '.parser') == $parserValue ? 'selected' : '' }}>
                                            {{ $parserName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="mapping_amounts_{{ $field }}_description"
                                       ...
                                       value="{{ old('mapping.amounts.' . $field . '.description', $config['description'] ?? '') }}"
                                       placeholder="Описание поля">
                            </div>
                        </div>
                    </div>
                ...
                <div class="field-group">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="mapping_items_start_row"
                            ...
                            value="{{ old('mapping.items.start_row', $defaultConfig['items']['start_row'] ?? 15) }}"
                            required>
                        <small class="form-text text-muted">Номер строки, с которой начинается табличная часть</small>
                    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control"
                                    ...
                                    value="{{ old('mapping.items.columns.' . $field . '.cell', $config['cell'] ?? '') }}"
                                    required placeholder="Только буква колонки (напр. A)">
                                <small class="form-text text-muted">Только буква колонки, без номера строки</small>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select class="form-control"
                                    ...
                                    @foreach($parsers as $parserValue => $parserName)
                                        <option value="{{ $parserValue }}" {{ old('mapping.items.columns.' . $field . '.parser') == $parserValue ? 'selected' : '' }}>
                                            {{ $parserName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control"
                                       ...
                                       value="{{ old('mapping.items.columns.' . $field . '.description', $config['description'] ?? '') }}"
                                       placeholder="Описание поля">
                            </div>
                        </div>
                    @endforeach
