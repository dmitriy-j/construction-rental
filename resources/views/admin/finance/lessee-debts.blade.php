...
@section('title', 'Долги арендаторов')

@section('content')
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            <h2>Долги арендаторов перед платформой</h2>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card text-bg-danger">
                <div class="card-body">
                    <h5 class="card-title">Общая задолженность</h5>
        ...
        <div class="col-md-4">
            <div class="card text-bg-primary">
                <div class="card-body">
                    <h5 class="card-title">Всего начислено по УПД</h5>
        ...
        <div class="col-md-4">
            <div class="card text-bg-dark">
                <div class="card-body">
                    <h5 class="card-title">Просроченная задолженность</h5>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-2">
                    <a href="{{ route('admin.finance.lessee-debts') }}" class="btn btn-outline-secondary w-100"><i class="bi bi-arrow-counterclockwise"></i> Сбросить</a>
                </div>
            </form>
        </div>
    </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-danger fw-bold text-end">{{ number_format($item->total_debt, 2) }} ₽</td>
                            <td>
