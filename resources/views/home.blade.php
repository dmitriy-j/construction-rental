...
<div class="container py-4">
    ...
    <div class="hero-section bg-primary text-white rounded-3 p-5 mb-5 position-relative overflow-hidden">
        <div class="position-absolute top-0 end-0 w-50 h-100 opacity-10">
            <div class="w-100 h-100" style="background: url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22%3E%3Ctext x=%2220%22 y=%2250%22 font-size=%2240%22 fill=%22white%22%3EФАП%3C/text%3E%3C/svg%3E') no-repeat center center;"></div>
        </div>
