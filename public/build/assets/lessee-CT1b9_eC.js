...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      balanceChartOptions: {
        ...
        plugins: { legend: { display: false } },
        scales: {
          y: { beginAtZero: false, ticks: { callback: (v) => v.toLocaleString("ru-RU") + " ₽" } }
        }
      },
      doughnutOptions: {
        responsive: true,
  ...
  computed: {
    expensesChartData() {
      var _a, _b;
      return ((_b = (_a = this.data) == null ? void 0 : _a.charts) == null ? void 0 : _b.expenses) || { labels: [], datasets: [] };
    },
    expensesByCategoryChartData() {
      var _a, _b;
      return ((_b = (_a = this.data) == null ? void 0 : _a.charts) == null ? void 0 : _b.expensesByCategory) || { labels: [], datasets: [] };
    },
    balanceHistoryChartData() {
      var _a, _b;
      return ((_b = (_a = this.data) == null ? void 0 : _a.charts) == null ? void 0 : _b.balanceHistory) || { labels: [], datasets: [] };
    }
  },
  mounted() {
    this.fetchData();
    ...
    fetchData() {
      return __async(this, null, function* () {
        ...
        try {
          ...
          const response = yield axios.get("/api/lessee/dashboard", { params });
          this.data = response.data;
        } catch (error) {
          console.error("Error fetching lessee dashboard data:", error);
        } finally {
          this.loading = false;
        }
      });
...
const _hoisted_1 = { class: "lessee-dashboard" };
...
const _hoisted_24 = { class: "row g-3 mb-4" };
const _hoisted_25 = { class: "col-lg-6" };
const _hoisted_26 = { class: "card shadow-sm h-100" };
const _hoisted_27 = { class: "card-body p-0" };
const _hoisted_28 = { class: "table-responsive" };
const _hoisted_29 = { class: "table table-hover mb-0" };
const _hoisted_30 = { class: "fw-bold" };
const _hoisted_31 = { key: 0 };
const _hoisted_32 = { class: "col-lg-6" };
const _hoisted_33 = { class: "card shadow-sm h-100" };
const _hoisted_34 = { class: "card-body" };
const _hoisted_35 = { key: 0 };
const _hoisted_36 = { class: "fw-bold" };
const _hoisted_37 = { class: "badge bg-warning text-dark" };
const _hoisted_38 = {
  key: 1,
  class: "text-center py-4 text-muted"
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      _cache[0] || (_cache[0] = createBaseVNode("h1", { class: "h3 mb-0" }, "Личный кабинет арендатора", -1)),
        ...
        createBaseVNode("div", _hoisted_11, [
          createBaseVNode("div", _hoisted_12, [
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "card-header bg-transparent border-bottom-0 pt-3 pb-0" }, [
              createBaseVNode("h5", { class: "mb-0" }, "Расходы по месяцам")
            ], -1)),
            createBaseVNode("div", _hoisted_13, [
              $data.data.charts.expenses.labels.length ? (openBlock(), createBlock(_component_Line, {
                key: 0,
                data: $options.expensesChartData,
        ...
        createBaseVNode("div", _hoisted_15, [
          createBaseVNode("div", _hoisted_16, [
            _cache[3] || (_cache[3] = createBaseVNode("div", { class: "card-header bg-transparent border-bottom-0 pt-3 pb-0" }, [
              createBaseVNode("h5", { class: "mb-0" }, "Расходы по категориям техники")
            ], -1)),
            createBaseVNode("div", _hoisted_17, [
              $data.data.charts.expensesByCategory.labels.length ? (openBlock(), createBlock(_component_Doughnut, {
                key: 0,
                data: $options.expensesByCategoryChartData,
        ...
        createBaseVNode("div", _hoisted_20, [
          createBaseVNode("div", _hoisted_21, [
            _cache[4] || (_cache[4] = createBaseVNode("div", { class: "card-header bg-transparent border-bottom-0 pt-3 pb-0" }, [
              createBaseVNode("h5", { class: "mb-0" }, "История баланса")
            ], -1)),
            createBaseVNode("div", _hoisted_22, [
              $data.data.charts.balanceHistory.labels.length ? (openBlock(), createBlock(_component_Line, {
                key: 0,
                data: $options.balanceHistoryChartData,
                options: $data.balanceChartOptions,
                height: 200
      ...
      createBaseVNode("div", _hoisted_24, [
        createBaseVNode("div", _hoisted_25, [
          createBaseVNode("div", _hoisted_26, [
            _cache[7] || (_cache[7] = createBaseVNode("div", { class: "card-header bg-transparent d-flex justify-content-between align-items-center" }, [
              createBaseVNode("h5", { class: "mb-0" }, "Последние заказы")
            ], -1)),
            createBaseVNode("div", _hoisted_27, [
              createBaseVNode("div", _hoisted_28, [
                createBaseVNode("table", _hoisted_29, [
                  _cache[6] || (_cache[6] = createBaseVNode("thead", { class: "table-light" }, [
                  ...
                  createBaseVNode("tbody", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList($data.data.recentOrders, (order) => {
                      return openBlock(), createElementBlock("tr", {
                        ...
                        createBaseVNode("td", _hoisted_30, toDisplayString($options.numberFormat(order.amount)) + " ₽", 1),
                    ...
                    !$data.data.recentOrders.length ? (openBlock(), createElementBlock("tr", _hoisted_31, [..._cache[5] || (_cache[5] = [
                      createBaseVNode("td", {
                        colspan: "4",
        ...
        createBaseVNode("div", _hoisted_32, [
          createBaseVNode("div", _hoisted_33, [
            _cache[9] || (_cache[9] = createBaseVNode("div", { class: "card-header bg-transparent" }, [
              createBaseVNode("h5", { class: "mb-0" }, "Ближайшие возвраты")
            ], -1)),
            createBaseVNode("div", _hoisted_34, [
              $data.data.upcomingReturns.length ? (openBlock(), createElementBlock("div", _hoisted_35, [
                (openBlock(true), createElementBlock(Fragment, null, renderList($data.data.upcomingReturns, (ret) => {
                  return openBlock(), createElementBlock("div", {
                    key: ret.id,
                    class: "d-flex justify-content-between align-items-center py-2 border-bottom"
                  }, [
                    createBaseVNode("div", null, [
                      createBaseVNode("span", _hoisted_36, "#" + toDisplayString(ret.id), 1)
                    ]),
                    createBaseVNode("span", _hoisted_37, toDisplayString(ret.end_date), 1)
                  ]);
                }), 128))
              ])) : (openBlock(), createElementBlock("div", _hoisted_38, [..._cache[8] || (_cache[8] = [
                createBaseVNode("i", { class: "bi bi-check-circle fs-1 d-block mb-2" }, null, -1),
                createTextVNode(" Нет ближайших возвратов ", -1)
              ])]))
            ])
          ])
        ])
...
const LesseeDashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-7e803792"]]);
